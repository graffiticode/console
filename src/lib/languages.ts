...
export const LANGUAGES: Language[] = [
  ...
  //
  // COVERAGE IS TWO INTERACTIONS, plus a wrapper. Choice — single-select, multi-select and
  ...
  // or a word inside the passage itself, including "click any three of these". The `item`
  // wrapper adds a reading passage and several parts scored together, so EBSR-style two-part
