...
export const LANGUAGES: Language[] = [
  ...
  { id: "0002", name: "L0002", description: "Core graffiticode language", category: "general", domains: ["graffiticode"] },
  ...
  { id: "0153", name: "L0153", description: "Area model questions", routingHint: "Area model multiplication questions with visual grid representations.", category: "data", domains: ["appliedscoring", "graffiticode"] },
  { id: "0154", name: "L0154", description: "Magic square questions", routingHint: "Magic square puzzle questions with grid-based number placement.", category: "data", domains: ["graffiticode"] },
  ...
  { id: "0158", name: "L0158", description: "Learnosity integrations", routingHint: "Learnosity assessment items — MCQ, short text, cloze, formula, classification, order list, and choice matrix question types via Learnosity API.", category: "data", domains: ["appliedscoring", "graffiticode"] },
