...
export const LANGUAGES: Language[] = [
  ...
  //
  // COVERAGE IS SIX INTERACTIONS, plus a wrapper. Choice — single-select, multi-select and
  ...
  // right sequence, scored all or nothing. Extended-text —
