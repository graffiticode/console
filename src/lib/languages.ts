...
export const LANGUAGES: Language[] = [
  ...
  //
  // COVERAGE IS FOUR INTERACTIONS, plus a wrapper. Choice — single-select, multi-select and
  ...
  // mistake can be explained back the way a chosen one is. Extended-text —
