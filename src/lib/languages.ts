...
export const LANGUAGES: Language[] = [
  ...
  //
  // NOT yet a composition target: L0158/L0176 embed a spreadsheet as a `custom` question that
  // loads the language's own scorer.js and question.js, which l0179 does not serve yet. Their
  // `composesWith: ["0166"]` therefore stays on L0166 until it does.
  //
