...
export const LANGUAGES: Language[] = [
  ...
  { id: "0177", name: "L0177", description: "Learnosity Authoring integration recipes (Author API + item bank)", routingHint: "Developer integration oracle for the Learnosity Author API and item bank (Data API). Given an authoring-integration task — embed the Learnosity item editor, save/update/fetch/list/tag item-bank items, sign author requests — it verifies the canonical request construction and returns (via get_spec) a host-language-neutral recipe: goal, preconditions, procedure (with the exact signature preimage), gotchas, and acceptance criteria. Does NOT author item content (that is L0176) and does NOT emit runnable code.", domains: ["learnosity", "integration"], status: "Beta" },
];
