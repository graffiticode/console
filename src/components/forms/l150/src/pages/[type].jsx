...
const PlaygroundForm = ({ setState, isLoading, data, qty, setQty }) => {
  const { items, prices, profits, yAxisName = "Net Margin" } = data;
  const profitsTable = makeProfitsTable({ data, qty });  
...
export const Form = ({ id, url, user, access_token }) => {
  ...
  case 2:
  default:
    elts = PlaygroundForm({ setState, isLoading, data, qty, setQty });
    break;
  }
