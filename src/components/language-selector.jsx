...
const languages = [
  ...
  {id: 4,  name: 'L0137', desc: "Data transformers", domains: ["graffiticode"]},
  {id: 5,  name: 'L0146', desc: "SVG scrapers", domains: ["hide"]},
  {id: 6,  name: 'L0147', desc: "Chart renderers", domains: ["graffiticode"]},
  {id: 7,  name: 'L0150', desc: "Free shipping calculators", domains: ["hide"]},
  {id: 8,  name: 'L0151', desc: "Spreadsheet questions", domains: ["graffiticode"]},
  {id: 9,  name: 'L0152', desc: "Interactive map questions", domains: ["questioncompiler"]},
  {id: 10, name: 'L0153', desc: "Area model questions", domains: ["questioncompiler"]},
  {id: 11, name: 'L0154', desc: "Magic square questions", domains: ["graffiticode"]},
  {id: 12, name: 'L0155', desc: "Stoplight questions", domains: ["graffiticode"]},
  {id: 13, name: 'L0156', desc: "Short text scorers", domains: ["questioncompiler"]},
  {id: 14, name: 'L0157', desc: "Geoboard manipulatives", domains: ["graffiticode"]},
  {id: 15, name: 'L0158', desc: "Learnosity integrations", domains: ["graffiticode"]},
  {id: 16, name: 'L0159', desc: "Card games", domains: ["graffiticode"]},
  {id: 17, name: 'L0160', desc: "XML transformers", domains: ["graffiticode"]},
  {id: 18, name: 'L0161', desc: "Expression translators", domains: ["graffiticode"]},
  {id: 19, name: 'L0162', desc: "Walking routes", domains: ["graffiticode"]},
  {id: 20, name: 'L0163', desc: "Code editors", domains: ["hide"]},
  {id: 21, name: 'L0164', desc: "Code generators", domains: ["hide"]},
];
