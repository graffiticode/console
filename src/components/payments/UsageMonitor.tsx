              ...
              <>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    } relative inline-flex h-6 w-11 items-center rounded-none transition-colors focus:outline-none focus:ring-2 ${billing.autoRecharge ? 'focus:ring-green-500' : 'focus:ring-gray-500'} focus:ring-offset-2`}
                  >
                    <span
                      className={`${
